            ...
            <div className="css-1i54mzy">
                                    ...
                                    <div className="tracing css-rvu8qh evjj7za0 snipcss0-3-3-23">
                                        ...
                                        <div className="arcade active css-1jxtjvn eh3x5v20 snipcss0-4-23-26">
                                            <div className="eh3x5v21 css-18nadfl e9fbm7j2 snipcss0-5-26-27"><iframe src="https://player.vimeo.com/video/1045059130?autoplay=1&amp;dnt=1&amp;background=1" allow="accelerometer; autoplay; encrypted-media; fullscreen; gyroscope; picture-in-picture autoplay" loading="lazy" className="css-srctpx e9fbm7j1 snipcss0-6-27-28"></iframe></div>
                                        </div>
                                    </div>
                                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 py-10 space-x-5 space-y-5">
            ...
            <div className="css-1i54mzy">
                                    ...
                                    <div className="tracing css-rvu8qh evjj7za0 snipcss0-3-3-23">
                                        <div className="background snipcss0-4-23-24"><span className="css-1lbs7b evjj7za2 snipcss0-5-24-25">Loading image for Find and fix the problem, no matter where it occurs media</span></div>
                                        <div className="arcade active css-1jxtjvn eh3x5v20 snipcss0-4-23-26">
                                            <div className="eh3x5v21 css-18nadfl e9fbm7j2 snipcss0-5-26-27"><iframe src="https://player.vimeo.com/video/1045072963?autoplay=1&amp;dnt=1&amp;background=1" allow="accelerometer; autoplay; encrypted-media; fullscreen; gyroscope; picture-in-picture autoplay" loading="lazy" className="css-srctpx e9fbm7j1 snipcss0-6-27-28"></iframe></div>
                                        </div>
                                    </div>
                                </div>
            <div className="text flex flex-col justify-center items-start gap-3">
